...
// // ! dizi olusuturac. cunku tekrar re-render olmasini istemiyoruz.
// const board = [[], [], []];
...
//   function changeTurn(row, col) {
//     board[row][col] = turn;
//     //! turn eger x ise sen bunu O yap, yoksa tekrardan X yap.
//     setTurn((turn) => (turn === "X" ? "O" : "X"));
//     console.log(board);
...
//       <div className="row">
//         <Box row={0} col={0} currentState={turn} changeTurn={changeTurn} />
//         <Box row={0} col={1} urrentState={turn} changeTurn={changeTurn} />
//         <Box row={0} col={2} currentState={turn} changeTurn={changeTurn} />
//       </div>
//       <div className="row">
//         <Box row={1} col={0} currentState={turn} changeTurn={changeTurn} />
